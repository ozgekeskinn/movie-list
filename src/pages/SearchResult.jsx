...
export default function SearchResult({
    ...
    const pageParameter = Number(
        searchParams.get("page")
    );

    const page =
        Number.isInteger(pageParameter) &&
        pageParameter > 0
            ? pageParameter
            : 1;
        ...
        return (
            <section className="search-results-page">
                ...
                <p className="empty-results">
                    Arama yapmak için yukarıdaki
                    alana bir film adı yazın.
                </p>
            </section>
        );
    }
    ...
    if (loading) {
        return (
            <Loading
                message={`“${query}” için sonuçlar yükleniyor...`}
            />
        );
    }
